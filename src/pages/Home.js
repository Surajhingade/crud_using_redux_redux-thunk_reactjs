...
const Home = () => {
  ...
  return (
    <>
      <div>
        <h2>Welcome to CRUD application using React,Redux and redux-thunk </h2>
      </div>
 
      <Button variant="contained" style={{ marginBottom: '15px' }} color='primary' ><Link to='/addUser' style={{ textDecoration: 'none', color: 'white' }}>Add User</Link></Button>
